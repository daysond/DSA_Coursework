...
template <typename T> void Sentinel<T>::push_front(const T &data) {
    Node *nn = new Node(data, front_->next_, front_);
    front_->next_->prev_ = nn;
    front_->next_ = nn;
}

template <typename T> void Sentinel<T>::push_back(const T &data) {
    Node *nn = new Node(data, back_, back_->prev_);
    back_->prev_->next_ = nn;
    back_->prev_ = nn;
}

template <typename T> void Sentinel<T>::pop_front() {
...
template <typename T> void Sentinel<T>::pop_back() {
    if (front_->next_ != back_) {
...
template <typename T> int Sentinel<T>::getData(int data[]) const {
...
template <typename T> int Sentinel<T>::getReverseData(int data[]) const {
